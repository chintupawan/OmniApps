...
export type SidebarProps = { books: Array<Book>, onbookSelect: (index: number) => void, onaddNewBook: (book: Book) => void; };
...
export type Book = { title: string, sections: Array<Section>, editMode: Boolean };
